...
20.2.	Переглянемо різницю між версіями файлу hello.html за допомогою команди show. (Скріншот)
20.3.	Перейменування hello.html:
-	Перейменуємо файл hello.html, використавши команду mv. (Скріншот команди та результату)
-	Додаємо зміну та перевіримо стан. (Скріншот)
20.4.	Безпечне переміщення файлу `style.css:
-	Створюємо папку css, безпечно переміщуємо за допомогою git mv, після чого ще раз перевіряємо стан. (Скріншот команди, результату створення папки та переміщення файлу в цю папку)
-	Закомітимо наші зміни і перевіримо історію змін у файлі css/styles.css та додаємо --follow, щоб побачити історію файлу до того, як він був переміщений. (Скріншот)
